...
3. Place the file in the GitHub repository, in the `p1_navigation/` folder, and unzip (or decompress) the file. 
...
6. Navigate to the `python/` folder of this repo and install several dependencies in the 'drlnd' conda environment.
```bash
